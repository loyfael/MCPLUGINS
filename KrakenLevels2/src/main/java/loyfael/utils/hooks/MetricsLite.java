...
public class MetricsLite {
     ...
     * This method is called using Reflection by bStats.
     *
    ...
    public JsonObject getPluginData() {
        ...
        // Utiliser l'API stable pour obtenir les informations du plugin
        String pluginName = plugin.getName();
        String pluginVersion;

        // Essayer d'abord la nouvelle API, puis revenir à l'ancienne si nécessaire
        try {
            pluginVersion = plugin.getPluginMeta().getVersion();
        } catch (NoSuchMethodError | Exception e) {
            // Fallback pour les anciennes versions ou si getPluginMeta() n'est pas disponible
